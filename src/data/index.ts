...
export const transType: TransTypeData[] = [
  { type: "Normal Purchase", cnt: 777, resp: 3.47, time: 49087, succ: 100.0, impact: 93.75, outlierness: 99.7 },
  { type: "Pre-authorization", cnt: 31, resp: 0.05, time: 0, succ: 100.0, impact: 3.38, outlierness: 0.1 },
  { type: "Cash Advance", cnt: 30, resp: 65.33, time: 68132, succ: 100.0, impact: 3.38, outlierness: 0.2 },
  { type: "Pre-auth Completion", cnt: 3, resp: 0.05, time: 0, succ: 0.0, impact: 0.38, outlierness: 0.1 },
  { type: "Merchandise Return", cnt: 5, resp: 40.0, time: 147121, succ: 60.0, impact: 0.38, outlierness: 0.3 },
];
